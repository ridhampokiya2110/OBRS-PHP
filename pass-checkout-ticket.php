<?php
    ...
    if(isset($_POST['bus_fare_checkout']))
    {
            ...
            */
            ...
            $query="update  obrs_passenger set pass_fare_payment_code = ? where pass_id=?";
                ...
                <div class="card-body">
                  <form method ="POST">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" readonly value="<?php echo substr($row->pass_phone, 0, 10);?>" id="inputText3" type="text" maxlength="10" pattern="[0-9]{10}">
                      </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" readonly  value="<?php echo $row->pass_bus_number;?>" id="inputText3" type="text">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Booked Train Name</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" readonly  value="<?php echo $row->pass_bus_name;?>" id="inputText3" type="text">
                      </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" readonly  value="<?php echo $row->pass_bus_fare;?>" id="inputText3" type="text">
                      </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <p class="text-right">
                          <input class="btn btn-space btn-success" value ="Checkout" name = "bus_fare_checkout" type="submit">
