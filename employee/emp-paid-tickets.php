<?php
  ...
  // Query to get Total Earning and Total Tickets
  $query = "SELECT SUM(total_cost) AS total_earning, COUNT(*) AS total_tickets FROM obrs_booking_history WHERE payment_status = 'Paid'";
...
<body style="background-color: #F0F0D7;">
  <div class="be-wrapper be-fixed-sidebar">
    ...
    <div class="be-content">
      <div class="page-head">
        <h2 class="page-head-title" style="color: black;">View Paid Tickets</h2>
        <nav aria-label="breadcrumb" role="navigation">
          <ol class="breadcrumb page-head-nav">
            ...
            <li class="breadcrumb-item active" style="color: black; text-decoration: underline;">View Paid</li>
          </ol>
        </nav>
      </div>
            ...
            <div class="card card-table" style="background: linear-gradient(120deg, #E0EAFC 0%, #CFDEF3 100%); color: #2C3E50; box-shadow: 0 4px 20px rgba(0,0,0,0.1); border-radius: 15px;">
              <div class="card-header" style="border-bottom: 1px solid rgba(44,62,80,0.1); padding: 25px;">
                <div class="d-flex justify-content-between align-items-center">
                  <h4 style="margin: 0; font-weight: 700; letter-spacing: 1px; text-transform: uppercase;">
                    <i class="fa fa-ticket" style="margin-right: 10px;"></i>Paid Tickets
                  </h4>
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <div class="text-center">
                      <h5 style="font-weight: 600; color: #2C3E50;">Total Tickets</h5>
