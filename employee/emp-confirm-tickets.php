<?php
    ...
    if(isset($_POST['bus_fare_confirm_checkout']))
    {
            ...
            $query="update obrs_bus_tickets set confirmation = ? where ticket_id = ?   ";
  ...
  <body>
    ...
    <!--Navigation Bar-->
      ...
      <div class="be-content">
        ...
        <?php
            $aid=$_GET['ticket_id'];
            $ret="select * from obrs_bus_tickets where ticket_id=?";
                ...
                <div class="card-body">
                  <form method ="POST">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" readonly name="bus_name"  value="<?php echo $row->bus_name;?>" id="inputText3" type="text">
                      </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" readonly name = "bus_fare"  value="<?php echo $row->bus_fare;?>" id="inputText3" type="text">
                      </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <p class="text-right">
                          <input class="btn btn-space btn-success" value ="Confirm Payment" name = "bus_fare_confirm_checkout" type="submit">
