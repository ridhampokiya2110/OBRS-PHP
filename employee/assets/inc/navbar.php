<?php
   /**
    * Server side code to get details of single employee using id 
    */
    $aid = $_SESSION['emp_id'];
    $ret = "select * from obrs_employee where emp_id=?"; // fetch details of employee
        ...
        <div class="container-fluid">
          <div class="flex items-center">
            <a href="emp-dashboard.php" class="flex items-center space-x-2">
              <div class="flex items-center">
                <h3 class="text-2xl ml-7 mr-5" style="font-family: 'Poppins', sans-serif; color: black; font-weight:700;">Employee Portal</h3>
              </div>
            </a>
          </div>
            ...
            <ul class="nav navbar-nav float-right be-user-nav">
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" role="button" aria-expanded="false" style="color: black;">
                  <img src="assets/img/profile/<?php echo $row->emp_dpic; ?>" alt="Avatar">
                  <span class="user-name" style="color: black;"><?php echo $row->emp_uname; ?></span>
                </a>
