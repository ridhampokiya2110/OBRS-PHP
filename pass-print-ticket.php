...
$query = "SELECT b.*, p.pass_fname, p.pass_lname, p.pass_email, p.pass_addr, p.pass_phone,
          ...
          WHERE b.id=? AND b.pass_id=? AND b.payment_status='Paid'";
...
<body style="background-color: #F0F0D7;">
  <div class="be-wrapper be-fixed-sidebar">
    ...
    <div class="page-head">
        <h2 class="page-head-title" style="color: black;">Your Magical Travel Pass</h2>
        <nav aria-label="breadcrumb" role="navigation">
          <ol class="breadcrumb page-head-nav">
            <li class="breadcrumb-item"><a href="pass-show-confirm-ticket.php" style="color: black;">Grab Your Golden Ticket!</a></li>
            <li class="breadcrumb-item active" style="color: black; text-decoration: underline;">Your Magical Travel Pass</li>
          </ol>
        </nav>
      </div>
              ...
              <div class="ticket-container" style="background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%); border-radius: 25px; padding: 40px; margin: 20px; box-shadow: 0 15px 35px rgba(0,0,0,0.15); position: relative; overflow: hidden; border: 2px solid #dee2e6;">
                ...
                <div class="bus-details" style="background: linear-gradient(135deg, #ffffff 0%, #f8f9fa 100%); padding: 35px; border-radius: 20px; margin-bottom: 35px; box-shadow: 0 10px 25px rgba(0,0,0,0.08); border: 1px solid #e9ecef;">
                  <div style="display: flex; justify-content: space-between; flex-wrap: wrap; gap: 35px;">
                    ...
                    <div style="flex: 1; min-width: 250px; background: rgba(155,89,182,0.05); padding: 30px; border-radius: 15px; transition: all 0.3s; box-shadow: 0 8px 20px rgba(0,0,0,0.05);">
                      <h4 style="color: #2c3e50; margin-bottom: 20px; font-size: 1.4em; font-weight: 700; text-transform: uppercase; letter-spacing: 1px; border-bottom: 2px solid rgba(155,89,182,0.2); padding-bottom: 15px;">
                        <i class="fa fa-credit-card" style="margin-right: 12px; color: #9b59b6;"></i>Payment Information
                      </h4>
                      <p style="color: #2c3e50; line-height: 2.2; font-size: 1.15em;">
                        <strong style="color: #34495e; display: inline-block; width: 150px;">Payment Status:</strong>
                        <span style="color: #27ae60; font-weight: 700;">Paid</span><br>
                        <strong style="color: #34495e; display: inline-block; width: 150px;">Payment Method:</strong>
                        <span style="color: #2c3e50; font-weight: 500;"><?php echo htmlspecialchars($booking->payment_method); ?></span><br>
                        <strong style="color: #34495e; display: inline-block; width: 150px;">Payment Date:</strong>
                        <span style="color: #2c3e50; font-weight: 500;"><?php echo htmlspecialchars($booking->booking_date); ?></span>
                      </p>
                    </div>
                  </div>
                </div>
  ...
  <script type="text/javascript">
    ...
    function shareTicket() {
      ...
      if (navigator.share) {
        navigator.share({
            title: 'My Bus Ticket',
            text: 'Check out my bus ticket from ' + '<?php echo htmlspecialchars($booking->dep_station); ?>' + ' to ' + '<?php echo htmlspecialchars($booking->arr_station); ?>',
