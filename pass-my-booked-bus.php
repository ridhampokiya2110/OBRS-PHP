                ...
                <div class="card-body">
                  <table class="table table-striped table-bordered table-hover table-fw-widget" id="table1">
                    ...
                    <tbody>
                         ...
                         */
                            //$aid=$_SESSION['pass_id'];
                            $ret="select * from obrs_passenger where pass_id=?";//sql to get details of our user
                            $stmt= $mysqli->prepare($ret) ;
                            $stmt->bind_param('i',$aid);
                            $stmt->execute() ;//ok
                            $res=$stmt->get_result();
                      ...
                      <tr class="odd gradeX even gradeC odd gradeA even gradeA ">
                        <td><?php echo $row->pass_bus_number;?></td>
                        <td><?php echo $row->pass_bus_name;?></td>
                        ...
                        <td class="center">$<?php echo $row->pass_bus_fare;?></td>
