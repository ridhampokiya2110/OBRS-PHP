      ...
      <div class="page-head">
          ...
          <nav aria-label="breadcrumb" role="navigation">
            <ol class="breadcrumb page-head-nav">
              ...
              <li class="breadcrumb-item"><a href="#" style="color: black;">Admin</a></li>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  ...
                  <div class="text-center">
                    <div class="relative inline-block">
                      <img
                        src="assets/img/profile/<?php echo $row->admin_dpic; ?>"
                        alt="Profile Picture"
                    ...
                    <h3 class="mt-4 text-xl font-bold text-gray-800">
                      <?php echo $row->admin_fname; ?> <?php echo $row->admin_lname; ?>
                    </h3>
                    <p class="text-gray-600">@<?php echo $row->admin_uname; ?></p>
                  </div>
                        ...
                        <div class="space-y-4">
                          <div class="flex items-center">
                            <div>
                              ...
                              <span class="ml-2 text-gray-600"><?php echo $row->admin_email; ?></span>
                            </div>
                          </div>
                        </div>
                      </div>
