...
<body style="background-color: #F0F0D7;">
  <div class="be-wrapper be-fixed-sidebar">
    ...
    <div class="be-content">
      <div class="page-head">
        <h2 class="page-head-title" style="color: black;">View Employee</h2>
        <nav aria-label="breadcrumb" role="navigation">
          <ol class="breadcrumb page-head-nav">
            <li class="breadcrumb-item"><a href="admin-dashboard.php" style="color: black;">Dashboard</a></li>
          ...
          <div class="col-md-8">
            <div class="card" style="background: linear-gradient(135deg, #E0EAFC 0%, #CFDEF3 100%); border-radius: 20px; box-shadow: 0 10px 30px rgba(0,0,0,0.15);">
              <div class="card-header text-center" style="background: rgba(255,255,255,0.1); border-bottom: 2px solid rgba(44,62,80,0.1); padding: 30px;">
                ...
                <h3 style="margin: 0; color: #2C3E50; font-weight: 700;"><?php echo $row->emp_fname;?> <?php echo $row->emp_lname;?></h3>
                <p style="color: #7F8C8D; margin-top: 5px;"><?php echo $row->emp_dept;?></p>
              </div>
              ...
              <div class="card-body" style="padding: 40px;">
                <div class="info-group" style="margin-bottom: 25px; padding: 20px; background: rgba(255,255,255,0.4); border-radius: 15px;">
                  ...
                  <div class="d-flex align-items-center" style="margin-bottom: 15px;">
                    ...
                    <span style="color: #2C3E50; font-size: 16px;"><?php echo $row->emp_phone;?></span>
                  </div>
                  <div class="d-flex align-items-center">
                    <i class="fa fa-envelope" style="font-size: 20px; color: #3498db; margin-right: 15px;"></i>
                    <span style="color: #2C3E50; font-size: 16px;"><?php echo $row->emp_email;?></span>
                  </div>
                </div>
                ...
                <div class="info-group" style="margin-bottom: 25px; padding: 20px; background: rgba(255,255,255,0.4); border-radius: 15px;">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <span style="color: #2C3E50; font-size: 16px;"><?php echo $row->emp_addr;?></span>
                  </div>
                </div>

                <div class="info-group" style="padding: 20px; background: rgba(255,255,255,0.4); border-radius: 15px;">
                  <label style="display: block; color: #34495E; font-weight: 600; margin-bottom: 10px;">Additional Details</label>
                  <div class="d-flex align-items-center" style="margin-bottom: 15px;">
                    <i class="fa fa-id-card" style="font-size: 20px; color: #3498db; margin-right: 15px;"></i>
                    <span style="color: #2C3E50; font-size: 16px;">ID: <?php echo $row->emp_nat_idno;?></span>
                  </div>
                  <div class="d-flex align-items-center">
                    <i class="fa fa-user" style="font-size: 20px; color: #3498db; margin-right: 15px;"></i>
                    <span style="color: #2C3E50; font-size: 16px;">Username: <?php echo $row->emp_uname;?></span>
                  </div>
                </div>
              </div>
              ...
              <div class="card-footer text-center" style="background: rgba(255,255,255,0.1); padding: 20px; border-top: 2px solid rgba(44,62,80,0.1);">
                <a href="admin-manage-employee.php" class="btn btn-primary" style="padding: 12px 30px; border-radius: 30px; background: linear-gradient(135deg, #3498db 0%, #2980b9 100%); border: none; box-shadow: 0 4px 15px rgba(52,152,219,0.3);">
                  <i class="fa fa-arrow-left mr-2"></i> Back to Employees List
                </a>
              </div>
            </div>
          </div>
